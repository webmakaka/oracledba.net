...
exec dbms_sqltune.create_sqlset(:sts_name, 'small GFK workload to test SQLPIA');
...
BEGIN
   ...
   OPEN stscur FOR
     ...
     FROM TABLE(dbms_sqltune.select_cursor_cache(
          'module=''SQL*Plus'' and sql_text like ''SELECT /* my_query%'' 
          and sql_text not like ''%ratio_to_report%''',
...
select sql_id, plan_hash_value, buffer_gets, elapsed_time, substr(sql_text,1, 22) text, executions
