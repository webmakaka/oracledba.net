---
layout: page
title: Preparing the environment (VirtualBox virtual machine) for installing Oracle database on Windows 2008 Server
description: Preparing the environment (VirtualBox virtual machine) for installing Oracle database on Windows 2008 Server
keywords: Oracle Database, Preparing the environment for installing Oracle database on Windows 2008 Server, VirtualBox
permalink: /database/installation/virtualbox-machines/windows/2008/
---

# Preparing the environment (VirtualBox virtual machine) for installing Oracle database on Windows 2008 Server
...
For the Windows 2k8 virtual machine
...
Connecting the hard disk controller (SATA). (With the SAS controller connected, Windows doesn't see hard disks)
...
rdesktop - all available options:<br/>
