---
layout: page
title: Oracle Database, Error Catcher
description: Oracle Database, Error Catcher
keywords: Oracle Database, Error Catcher
permalink: /docs/architecture/other/oracle-err-catcher/
---

# Oracle Database, Error Catcher
...
<strong>Create a table for recording error messages.</strong>
