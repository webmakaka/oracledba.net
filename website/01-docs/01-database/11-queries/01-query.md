---
layout: page
title: Some Oracle database queries
description: Some Oracle database queries
keywords: Oracle Database, Some Oracle database queries
permalink: /docs/architecture/queries/query/
---

# Some Oracle database queries:

<br/>

```sql
-- which segment hits corrupted blocks
...
https://t.me/oracledba_net/49323
...
```sql
--  Database version including installed PSU.
--  12 and 21+ versions
declare
  l_rel int;
  l_ver varchar2(30);
...
https://t.me/oracledba_net/39524

<br/>

```sql
-- Tracking Oracle Option Usage (Which Oracle Database options have been used):
...
```sql
-- Set directory where files will be created
...
```sql
-- Identify users with highest CPU resource usage
...
```sql
-- Top 10 tables that grew the most in the last month
select *
...
https://t.me/oracledba_net/26798
