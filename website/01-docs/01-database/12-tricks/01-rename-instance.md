---
layout: page
title: Renaming Oracle 11 instance in linux
description: Renaming Oracle 11 instance in linux
keywords: Oracle Database, Renaming instance
permalink: /database/tricks/rename-oracle-instance/
---

# Renaming Oracle 11 instance in linux

**Renaming the database to primary (purely for convenience) on the server**
...
It is necessary that the server is started from spfile
