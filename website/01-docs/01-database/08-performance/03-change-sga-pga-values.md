---
layout: page
title: Change SGA and PGA parameters
description: Change SGA and PGA parameters
keywords: Oracle Database, Change SGA and PGA parameters
permalink: /database/performance/change-sga-pga-values/
---

# Change SGA and PGA parameters (Oracle 11.2)
...
To find out whether PFILE or SPFILE was used at startup, execute the query:
...
Now I need to reduce the SGA size,<br/>
When executing the above commands, the size remains the same.
...
```
I DON'T REMEMBER IF YOU CAN DO THIS.
DOING ON A TEST MACHINE!!!
```
