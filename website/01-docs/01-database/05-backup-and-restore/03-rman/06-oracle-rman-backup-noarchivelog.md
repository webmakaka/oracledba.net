---
layout: page
title: Creating backups using RMAN (NOARCHIVELOG)
description: Creating backups using RMAN (NOARCHIVELOG)
keywords: Oracle Database, RMAN, creating backups, NOARCHIVELOG
...
# I needed to restore a database from a cold backup. Not the one described above. And yes, on a test environment.
...
How is that, what recovery, if the backup is cold.
...
I don't know, maybe it could have been just restored, without explicitly specifying where to get the controlfile.
