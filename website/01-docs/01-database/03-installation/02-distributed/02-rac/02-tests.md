---
layout: page
title: Some queries and commands for RAC
description: Some queries and commands for RAC
keywords: Some queries and commands for RAC
permalink: /database/installation/distributed/rac/tests/
---

# Some queries and commands for RAC
