---
layout: page
title: Oracle RAC 12.1 Installation on Oracle Linux 6.7 (ISCSI + ASM) - Network interface configuration and hosts file
description: Oracle RAC 12.1 Installation on Oracle Linux 6.7 (ISCSI + ASM) - Network interface configuration and hosts file
...
# [Oracle RAC 12.1 Installation on Oracle Linux 6.7 (ISCSI + ASM)]: Network interface configuration and hosts file
...
You can restart network interfaces with the following command:
