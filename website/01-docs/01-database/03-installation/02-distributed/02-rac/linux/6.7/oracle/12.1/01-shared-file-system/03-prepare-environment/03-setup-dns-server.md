---
layout: page
title: Oracle RAC 12.1 SHARED FILE SYSTEM - DNS server setup
description: Oracle RAC 12.1 SHARED FILE SYSTEM - DNS server setup
...
# [Oracle RAC 12.1 SHARED FILE SYSTEM Installation]: DNS server setup
...
The DNS server is configured only for the purpose of making RAC work. If you need a properly working DNS server, you should refer to special DNS server setup guides.
...
### DNS server configuration files setup:
