---
layout: page
title: Oracle RAC 11.2 Installation on Oracle Linux 5.8 (ISCSI + ASM) - Grid Installation
description: Oracle RAC 11.2 Installation on Oracle Linux 5.8 (ISCSI + ASM) - Grid Installation
keywords: database, installation, distributed, rac, linux, 5.8, oracle, 11.2, Grid Installation
permalink: /database/installation/distributed/rac/linux/5.8/oracle/11.2/grid-installation/
---

# <a href="/database/installation/distributed/rac/linux/5.8/oracle/11.2/">[Oracle RAC 11.2 Installation on Oracle Linux 5.8 x86_64]</a>: Grid Installation

<br/>

Oracle Software Installation (GRID)
...
Make sure the gid is dba

<br/>

    $ /tmp/oracle/11.2.0.3

Remove the current ORACLE_BASE ORACLE_HOME environment variables. They are currently set incorrectly.
...
In this case 192.168.1.200 is the ip address of the computer from which the installation process is being controlled.

Xming is installed and started on 192.168.1.200
...
<img src="https://img.oracledba.net/img/oracle/database/rac/11.2/rac_grid_installation_11.PNG" border="0" alt="Oracle RAC installation"><br/><br/>
