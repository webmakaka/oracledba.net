---
layout: page
title: Oracle RAC 11.2 Installation on Oracle Linux 5.8 (ISCSI + ASM) - Configuring DNS server
description: Oracle RAC 11.2 Installation on Oracle Linux 5.8 (ISCSI + ASM) - Configuring DNS server
keywords: database, installation, distributed, rac, linux, 5.8, oracle, 11.2, Configuring DNS server
permalink: /database/installation/distributed/rac/linux/5.8/oracle/11.2/setup-dns-server/
---

# <a href="/database/installation/distributed/rac/linux/5.8/oracle/11.2/">[Oracle RAC 11.2 Installation on Oracle Linux 5.8 x86_64]</a>: Configuring DNS server

<br/>

The DNS server is configured only for RAC to work. If you need a properly working DNS server, you should refer to special DNS configuration guides.
...
Installing packages from the Oracle Linux online repository:
