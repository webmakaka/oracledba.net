---
layout: page
title: Configuring Instance parameters after creating the duplicate on standby
description: Configuring Instance parameters after creating the duplicate on standby
...
# [Oracle Active DataGuard 12.1 Installation on Centos 6.7]: Configuring Instance parameters after creating the duplicate on standby

### STANDBY

    SQL> alter system set LOG_ARCHIVE_CONFIG="DG_CONFIG=(master, slave)" scope=both;

I spent who knows how long because I was specifying the SERVICE incorrectly. In short, the SERVICE value comes from tnsnames.ora. I was putting db_unique_name in the SERVICE field.
...
### Additional Listener configuration on standby

I don't like that listener.ora is in different directories.
