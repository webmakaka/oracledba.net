---
layout: page
title: Oracle DataBase 12c Installation on Oracle Linux 6.7 - Installing Oracle DBMS (DataBase Software)
description: Oracle DataBase 12c Installation on Oracle Linux 6.7 - Installing Oracle DBMS (DataBase Software)
keywords: Oracle DataBase 12c, Oracle Linux 6.7, Installing DataBase Software
permalink: /database/installation/single-instance/simple/linux/6.7/oracle/12.1/oracle-database-software-installation/
---

# <a href="/database/installation/single-instance/simple/linux/6.7/oracle/12.1/">[Oracle DataBase Server 12.1 Installation on Oracle Linux 6.7]</a>: Installing Oracle DBMS (DataBase Software)
