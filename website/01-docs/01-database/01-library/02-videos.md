---
layout: page
title: Oracle DBA Library - video courses
description: Oracle DBA Library - video courses
keywords: Oracle DataBase, Oracle DBA Library, video courses
permalink: /database/library/videos/
---

# Oracle DBA Library - video courses

<br/>

### [Igor Mironchik] Oracle19c from installation to recovery [RUS, 2021]
...
### Video courses from "Specialist":

You can try to find courses from the Specialist training center. All 5 parts. For version 11.

<br/><br/>

<div style="padding:10px; border:thin solid black;">

    <h3>Recommend good materials for studying Oracle database, application servers, BI, etc</h3>
...
On udemy there are paid and free video courses.

**What interested me about Oracle:**
...
<ul>
    ...
    <li><strong>Easy way to set Oracle Active Dataguard</strong> (recommended for beginners)</li>

    <li><strong>Oracle Real Application Cluster</strong> (recommended for beginners)</li>
