---
layout: page
title: Installation of Oracle BI EE (OBIEE)
description: Installation of Oracle BI EE (OBIEE)
keywords: Oracle Business Intelligence, OBIEE, installation
permalink: /business-intelligence/oracle-bi-server-installation/
---

# Installation of Oracle BI EE (OBIEE)
...
The following packages must be installed on OEL6:
...
-- uln-internal-setup - Not found in the standard repository, didn't look in others.

Copying to the server in the /tmp/\_oralce_bi directory
...
If you don't unzip all archives, during installation a message will appear asking you to specify the source location of the files needed for installation.
